...
public class FindProducteByName_ProducteTest {
    ...
    public void findUserByLogin() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get("/products/byname/" + producte.getName())
                .contentType(contentType)
                .content(userJson);
        Mockito.when(productService.findProductByName(producte.getName())).thenReturn(savedProducte);
        mockMvc.perform(request)
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.content().contentType(contentType))
                .andExpect(MockMvcResultMatchers.jsonPath("$.name", Matchers.is(producte.getName())));
    }
