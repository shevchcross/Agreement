...
public class GetProducteById_ProducteControllerTest {
    ...
    public void getUserById() throws Exception {
        ...
        MockHttpServletRequestBuilder request = MockMvcRequestBuilders.get("/products/"+producte.getId())
        ...
        mockMvc.perform(request)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.id", Matchers.is((int)producte.getId())));
    }
